	  ...
	  <section class="content">
	    ...
	    <div class="box">
	      <div class="box-header with-border">
	        <center><a class="btn btn-primary" href="{{ route('tag.create') }}">Add New</a></center> 
                	...
                	@if(count($tags) > 0)
                		...
                		@foreach($tags as $tag )
			                ...
			                <tr>
			                  ...
			                  <td>
			                  	<form action="{{ route('tag.destroy', $tag->id) }}"  id="delete-form-{{ $tag->id }}" style="display: none" method="post">
			                  	{{ csrf_field() }}	
