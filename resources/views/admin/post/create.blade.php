          ...
          <form role="form"  action="{{ route('post.store') }}" method="post"  enctype="multipart/form-data" >
            ...
            {{csrf_field()}}
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="subtitle" name="subtitle" placeholder="Post Sub Title" value="{{old('subtitle')}}" >
                </div>
                ...
                <div class="form-group col-md-6">
                  <br>
                  <label>
                    <input type="checkbox" name="status" value="1"> Publish Post
                  </label>
              </div>
                </div>
                @endcan
