                            ...
                            <div class="widget w-insta">
                             ...
                             <div class="widget w-insta">
                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="side-letest">
                                        <div class="sidelist-img">
                                            <a href="{{ route('post', $originalpost->slug) }}"><img src="{{ Storage::disk('local')->url($originalpost->image)}}" alt="image"></a>
                                        </div>
                                        <div class="sidelist-info">
                                            <h4><a href="{{ route('post', $originalpost->slug) }}">{{ $originalpost->title}}</a></h4>
                                            <span class="post-date"> {{  $originalpost->created_at->toFormattedDateString()}}</span>
                                        </div>
                                    </div>
